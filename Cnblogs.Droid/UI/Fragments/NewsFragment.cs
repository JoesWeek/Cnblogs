...
namespace Cnblogs.Droid.UI.Fragments
{
    public class NewsFragment : Fragment, TabLayout.IOnTabSelectedListener
    {
        ...
        private NewsTabsAdapter adapter;
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            return view = inflater.Inflate(Resource.Layout.fragment_news, container, false);
        }
        public override void OnViewCreated(View view, Bundle savedInstanceState)
        {
            ...
            adapter = new NewsTabsAdapter(this.ChildFragmentManager, this.Activity.Resources.GetStringArray(Resource.Array.NewsTabs).ToList());
